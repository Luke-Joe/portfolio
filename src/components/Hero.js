    ...
    <>
      <div className="flex justify-center items-center dynamic-card">
        <div className="text-slate-200 bg-slate-800 sm:max-w-xl px-16">
          <h1 className="flex uppercase font-black text-3xl pb-3">Luke Joe</h1>
          <p>
            {" "}
          ...
          <div className="px-4 flex items-center justify-center space-x-5 py-10">
            <a
              href="https://www.linkedin.com/in/luke-joe-77282b189/"
              target="_blank"
            >
            ...
            <a href="https://github.com/Luke-Joe" target="_blank">
