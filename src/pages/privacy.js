...
const privacy = () => {
  return (
    <div className="h-fit flex-auto justify-center items-center bg-yellow-300 xl:px-96 lg:px-72 md:px-52 sm:px-40 px-16 py-24 border-black border-solid rounded-2xl border-2 space-y-1">
      <strong className="lg:text-6xl md:text-5xl sm:text-4xl text-4xl font-black mb-14">
        Privacy Policy
      </strong>{" "}
      <p class="privacy-par">
        Temos Games built the Mondo Dodgeball app as an Ad Supported app. This
        SERVICE is provided by Temos Games at no cost and is intended for use as
        is.
      </p>{" "}
      <p class="privacy-par">
      ...
      <p class="privacy-par">
        ...
        Terms and Conditions, which are accessible at Mondo Dodgeball unless
        otherwise defined in this Privacy Policy.
      </p>{" "}
      <p class="privacy-par">
        <strong className="sm:text-3xl text-3xl font-black mb-14">
      ...
      <p class="privacy-par">This policy is effective as of 2022-09-20</p>{" "}
      <p class="privacy-par">
        <strong className="text-3xl font-black mb-14">Contact Us</strong>
      </p>{" "}
      <p class="privacy-par">
        If you have any questions or suggestions about my Privacy Policy, do not
        hesitate to contact me at TemosDev@gmail.com.
      </p>{" "}
      <p class="privacy-par">
