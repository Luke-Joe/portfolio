  ...
  return (
    <>
      <div className="text-white">
        <div className="flex-auto py-12 text-center p-0 bg-yellow-500 h-40">
          <strong className="lg:text-6xl md:text-5xl sm:text-4xl text-4xl font-black mb-14">
            Privacy Policy
          </strong>{" "}
        </div>
        <div className="h-fit flex-auto justify-center items-center xl:px-96 lg:px-72 md:px-52 sm:px-40 px-16 py-12">
          <p class="privacy-par privacy-header">
            <strong>Overview</strong>
          </p>{" "}
          <p class="privacy-par">
            Temos Games built the Mondo Dodgeball app as an Ad Supported app.
            This SERVICE is provided by Temos Games at no cost and is intended
            for use as is.
          </p>{" "}
          <p class="privacy-par">
          ...
          <p class="privacy-par">
            ...
            our Terms and Conditions, which are accessible at Mondo Dodgeball
          ...
          <p class="privacy-par">
            ...
            not hesitate to contact me at TemosDev@gmail.com.
          </p>{" "}
          <p class="privacy-par">
